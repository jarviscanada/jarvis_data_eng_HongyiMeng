           ...
           EXEC SQL
               DECLARE C1 CURSOR FOR
                   SELECT STUD_ID,
                       ...
                       STUD_UPDT_DATE
                   FROM TSTUDENT
                   ORDER BY STUD_COURSE DESC NULLS LAST
           END-EXEC.
       01 WS-WORK-AREAS.
           88 NO-MORE-ROWS VALUE HIGH-VALUE.
           05  PREV-COURSE PIC X(15).
           05 REPORT-SEPERATOR.
      ...
      -        "-----".
           05 REPORT-TITLE.
               ...
               10 FILLER PIC X(23) VALUE "STUDENTS BY COURSE".
       ...
       0400-WRITE-RECORD.
           ...
           END-EXEC.
           IF SQLCODE EQUAL +0
             IF PREV-COURSE EQ REPORT-COURSE
               WRITE REP-DATA FROM REPORT-RECORD AFTER ADVANCING 1 LINE
             ELSE
               MOVE REPORT-COURSE TO PREV-COURSE
